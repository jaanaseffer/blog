...
<head>
    ...
    <link rel="shortcut icon" href="assets/img/loader.gif">
...
<nav class="navbar navbar-epand-sm navbar-dark bg-dark">
    <div class="container">
        ...
        <ul class="navbar-nav">
            ...
            <li title="<?=__('Log out')?> <?= $auth->name ?>" class="nav-item"><li class="nav-link" href="logout"><a class="glyphicon glyphicon-log-out" aria-hidden="true">Log Out</a></li>
        </ul>
    </div>
</nav>
